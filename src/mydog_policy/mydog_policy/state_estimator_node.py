...
class MydogStateEstimatorNode(Node):
    def __init__(self):
        ...
        self.declare_parameter("http_timeout", 0.04)
        self.declare_parameter("stale_recheck_once", False)
        self.declare_parameter("warn_period_sec", 0.5)
        ...
        self.stale_recheck_once = bool(self.get_parameter("stale_recheck_once").value)
        ...
        self.motor = MotorStateHttpInterface(
            ...
            enable_stale_recheck=self.stale_recheck_once,
        )
    ...
    def update(self):
        try:
            ...
            if max_age > self.max_motor_age_ms:
                ...
                if now - self._last_stale_warn_time >= self.warn_period_sec:
