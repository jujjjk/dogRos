...
class FanfanIkGaitNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("fl_calf_lift_scale", 0.50)
        ...
        self.fl_calf_lift_scale = float(self.get_parameter("fl_calf_lift_scale").value)
    ...
    def build_urdf_forward_crawl_target_policy(self, phase: float, warm: float):
        ...
        for leg in LEG_ORDER:
            ...
            if leg == "FL":
                lift_extra *= self.fl_calf_lift_scale
    ...
    def old_compute_calf_dominant_target(
        ...
        if leg == "FL":
            calf_lift_extra *= self.fl_calf_lift_scale
        calf_stance_push = (
    ...
    def build_old_forward_calf_walk_target_policy(self, phase: float, warm: float):
        ...
        for leg in LEG_ORDER:
            ...
            calf_swing_scale = (
                self.front_calf_swing_scale if is_front else self.rear_calf_swing_scale
            )
